...
class QuotationMaster(models.Model):
    ...
    status = models.IntegerField( choices=STATUS_CHOICES, default=1, null=True, blank=True, verbose_name="状态" )
    ...
    quotetime = models.DateTimeField( null=True, blank=True, verbose_name="报价时间" )
