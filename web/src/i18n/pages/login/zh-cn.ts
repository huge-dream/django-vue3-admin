...
export default {
	...
	register: {
		registerPlaceholder1: '请输入账号',
		registerPlaceholder2: '请输入密码',
		registerPlaceholder3: '请再次输入密码',
		registerPlaceholder4: '请输入昵称',
		registerPlaceholder5: '请输入邮箱',
		registerPlaceholder6: '请输入验证码',
		registerBtnText: '注 册',
	},
	scan: {
