<template>
	<fs-page class="PageFeatureSearchMulti">
		<fs-crud ref="crudRef" v-bind="crudBinding">
			...
			<!-- 注释编号: Procurement Inquiry System-index442216: -->
			<!-- 注释编号:Procurement Inquiry System-index39263917:代码开始行-->
			...
			<!--  注释编号:Procurement Inquiry System-index263917:代码结束行-->
...
// 注释编号: Procurement Inquiry System-index192316:导入组件
import importExcel from '/@/components/importExcel/index.vue'   


export default defineComponent({    //这里配置defineComponent
    name: "VIEWSETNAME",   //把name放在这里进行配置了
	components: {importExcel},  //注释编号: Procurement Inquiry System-index552416: 注册组件，把importExcel组件放在这里，这样<template></template>中才能正确的引用到组件
    setup() {   //这里配置了setup()
