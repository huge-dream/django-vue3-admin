        ...
        <el-tab-pane label="基础信息" name="base">
          <el-form :model="form" :disabled="isViewMode" label-width="120px" class="grid-form">
            ...
            <el-form-item label="采购部门">
              <el-input v-model="form.purchase_dept" placeholder="根据模版自动带出" disabled />
            </el-form-item>
            ...
            <el-form-item label="采购数量">
              <el-input-number v-model="form.purchase_qty" :min="0" :precision="2" controls-position="right" />
            </el-form-item>            
